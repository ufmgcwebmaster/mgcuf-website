...
export default function Home() {
  ...
  const PillarCard = ({ pillar, bulletPoints }) => {
    ...
    const bulletComponent = bulletPoints.map((bulletPoint) => (
      <li key={bulletPoint} className="text-white ml-5 text-xs md:text-sm xl:text-base">{bulletPoint}</li>
    ))
      ...
      <main className={styles.parallax}>
        ...
        <div className='bg-gray-900 flex flex-col items-center p-8 lg:p-10 xl:p-12'>
          ...
          <div className='flex flex-wrap items-start justify-center'>
            ...
            <PillarCard pillar="service" bulletPoints={["Philanthropy: Adopt-A-Classroom for East Gainesville schools", "Semesterly service events", "Fundraisers", "Individual service opportunities", "he Greek Giving Initiative"]} />
